        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                    ...
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      ...
                      <path
                        className={`fill-current text-slate-600 ${
                          pathname === "/" && "text-lime-800"
                        }`}
                        d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                      />
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname === "/" && "text-lime-200"
                        }`}
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("categorie") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/categorie"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                    pathname.includes("categorie") && "hover:text-slate-200"
                  }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-slate-600 ${
                          pathname.includes("categorie") && "text-lime-800"
                        }`}
                        d="M0 20h24v2H0z"
                      />
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname.includes("categorie") && "text-lime-300"
                        }`}
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("mvoDoelstelling") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/mvoDoelstelling"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                    pathname.includes("mvoDoelstelling") &&
